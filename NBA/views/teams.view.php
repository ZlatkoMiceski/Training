...
<div id="wrapper">
    ...
    <ul class="sidebar navbar-nav">
        ...
        <?php foreach ($dispteam as $user) : ?>
            <li class="nav-item">
                <a class="nav-link" href="../controllers/teams.php?name=<?= $user->TeamName?>&id=<?= $user->id?>" title="Bam Abedayo"> <!--Link to teams.php -->
    ...
    <div id="content-wrapper">
        ...
        <div class="container-fluid">
            ...
            <p><?php var_dump($disptm) ?></p>

            <p><?php echo $disptm[0]->TeamName; ?></p>
            ...
            <img src="../images/<?php echo $disptm[0]->TeamName; ?>.svg" class="img-fluid" alt="<?php echo $disptm[0]->TeamName; ?>">



            <!--Displaying all Players from selected Team -->


            <div class="row">

                <?php foreach ($dispAllPlayersbyTeam as $user) : ?>
